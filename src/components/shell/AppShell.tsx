    ...
    <>
      ...
      {immersive ? (
        ...
        <div className="flex h-dvh flex-col overflow-hidden bg-[#FAF8F3]">
          <main
            className={`mx-auto min-h-0 w-full max-w-[1200px] flex-1 overflow-y-auto overscroll-y-contain px-4 pb-6 pt-2 sm:px-6 sm:pb-8 sm:pt-4 ${
              onMusic ? "max-sm:px-2 max-sm:pb-2 max-sm:pt-1" : ""
            }`}
          >
            {children}
          </main>
